...
export default function Contact(){
    return (
        <div id="contact" className="bg-[rgb(243,243,243)] flex flex-col items-center mt-10">
            ...
            <div className="flex flex-col items-center justify-center mt-10 md:flex-row md:w-full md:gap-20">
                <div className="flex flex-col items-center mt-10 md:mt-14 md:mb-24 md:w-1/4">
                ...
                <div className="flex flex-col items-center mt-14 mb-20 md:w-1/4">
                    <div className="p-5 mb-4 rounded-full shadow-[0_0_10px_rgba(0,0,0,0.1)]">
